...
def sendmessage1(request, payload:MessageSchema):
    try:
        ...
        channel.basic_publish(exchange="", routing_key=queue_name, body=payload.message)
        ...
        traceback.print_exc()
        return {"Hata": "Mesaj gönderilemedi"}
